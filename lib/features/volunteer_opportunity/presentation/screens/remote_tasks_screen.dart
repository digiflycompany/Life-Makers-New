...
class RemoteTasksScreen extends StatefulWidget {
  ...
  @override
  State<RemoteTasksScreen> createState() =>
      _RemoteTasksScreenState();
}

class _RemoteTasksScreenState
    extends State<RemoteTasksScreen> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: PreferredSize(
        ...
        child: Stack(
            children:[
              Image.asset('assets/images/volunteer3.png',
